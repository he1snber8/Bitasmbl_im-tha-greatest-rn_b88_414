...
function parseFileChange(ctx) {
    ...
    while (!ctx.isEof()) {
        ...
        if (extHeader.type === constants_js_1.ExtendedHeader.OldMode) {
            oldMode = extHeader.mode;
        }
        if (extHeader.type === constants_js_1.ExtendedHeader.NewMode) {
...
function parseExtendedHeader(ctx) {
    ...
    else if (type === constants_js_1.ExtendedHeader.OldMode ||
        type === constants_js_1.ExtendedHeader.NewMode) {
        return {
            type,
